...
/**
 * Logical Decoding TApplSeq
*/

public class TApplSeq implements Runnable {

    private static final Logger LOGGERA= LogManager.getLogger(TApplSeq.class.getName());
 ...
 public static boolean isNullOrEmpty(String myString)
	...
	options.addOption(threadnum);
 	...
 	try {
        	...
        	formatter.printHelp("TApplSeq", options);
		isInitialized = false ;
   	}
	...
	LOGGERA.info("Running TApplSeq consumer " + nodeslv + " for node " + nodemst);
    ...
    public static void main(String[] args) {
        ...
        TApplSeq app = new TApplSeq(args);
