...
-- Started on 2019-06-12 11:18:42 CEST
...
CREATE FUNCTION _rdb_bdr.hex2dec(text) RETURNS bigint
    LANGUAGE sql
    AS $_$
...
CREATE SEQUENCE _rdb_bdr.walq__master_wid_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
#
--
-- TOC entry 198 (class 1259 OID 49789800)
-- Name: walq__master; Type: TABLE; Schema: _rdb_bdr; Owner: rdbbdr_user
--
#
...
(
    ...
    n_master character varying COLLATE pg_catalog."default" NOT NULL,
...
#
#
CREATE TABLE _rdb_bdr.tc_monit
(
    db_xid_last_committed bigint,
    db_last_committed_dateop timestamp without time zone,
    wal_lsn pg_lsn,
    ...
    state boolean,
    check_dateop timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    n_master character varying(20) COLLATE pg_catalog."default" NOT NULL,
    n_slave character varying(20) COLLATE pg_catalog."default" NOT NULL,
    flushed_lsn pg_lsn,
    xid_offset bigint,
    CONSTRAINT tc_monit_pkey PRIMARY KEY (n_master, n_slave)
)
WITH (
    OIDS = FALSE
)
...
#
#
-- Completed on 2019-06-12 11:18:42 CEST
#
--
-- PostgreSQL database dump complete
--
#
CREATE FUNCTION _rdb_bdr.upd_walq__master_hist() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
(
    ...
    CONSTRAINT ddl_trace_pkey PRIMARY KEY (ddl_id)
)
WITH (
    OIDS = FALSE
)
