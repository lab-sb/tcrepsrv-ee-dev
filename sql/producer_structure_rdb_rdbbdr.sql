...
CREATE TABLE IF NOT EXISTS _rdb_bdr.walq__master (
    ...
    dateop timestamp without time zone DEFAULT current_timestamp,
    current_xid bigint,
    current_dateop timestamp without time zone DEFAULT current_timestamp,
    local_xid bigint NOT NULL
...
create view _rdb_bdr.v_tc_monit as
 select *,pg_xact_commit_timestamp(q_xid::varchar::xid) - pg_xact_commit_timestamp(xid_offset::varchar::xid) as "gap"
 from _rdb_bdr.tc_monit order by n_mstr,n_slv;
